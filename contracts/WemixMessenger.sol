...
contract WemixMessenger is CCIPReceiver {
    ...
    constructor(address _router, address _link, address _nft) CCIPReceiver(_router) {
        s_linkToken = IERC20(_link);
        nft = AssetNexusNft(_nft);
    }
        ...
        ) // Make sure source chain and sender are allowlisted
    {
        ...
        address(nft).call(any2EvmMessage.data);
