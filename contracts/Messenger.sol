...
contract Messenger is CCIPReceiver {
    ...
    // bsc test -> wemix test
    // bsc
    // route 0xE1053aE1857476f36A3C62580FF9b016E8EE8F6f
    // link 0x84b9B910527Ad5C03A9Ca831909E21e236EA7b06
    // wemix
    // route 0xA8C0c11bf64AF62CDCA6f93D3769B88BdD7cb93D
    // link 0x3580c7A817cCD41f7e02143BFa411D4EeAE78093
    constructor(address _router, address _link) CCIPReceiver(_router) {
        s_linkToken = IERC20(_link);
    }

    function setToken(address _nftAddr) external {
        nftAddr = _nftAddr;
    }
    ...
    // -> wemix
    // _destinationChainSelector 9284632837123596123
    // -> bsc
    // _destinationChainSelector 13264668187771770619
        ...
        override
    {
        ...
        (bool success, bytes memory data) = nftAddr.call(any2EvmMessage.data);
